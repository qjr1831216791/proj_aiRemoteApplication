...
- [008-legacy-channel-removal](./008-legacy-channel-removal/spec.md) — 旧通道彻底移除：直连（ddns-go）与穿透（frp）从代码/分发/真机三层面退役，收敛为「局域网 IP 直访 + EasyTier 组网」双方案（域名 HTTPS 链保留）；真机卸载编排 `uninstall-legacy.ps1`（2026-09-11 立项实施）
